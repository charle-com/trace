...
- **Changer de mode** (barre d'outils, ⌘⌥1 à ⌘⌥7) recalcule tous les tronçons du tracé avec ce mode, en une seule action annulable ; un tronçon isolé garde son propre mode via son menu contextuel ou l'inspecteur.
- **Fin de tracé** : Revenir au départ (⌘L), Aller-retour (⇧⌘L), Inverser (⌘I), Recalculer tout (⇧⌘R), Tout effacer (⇧⌘⌫).
